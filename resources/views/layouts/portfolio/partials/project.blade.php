<div class="container text-center" id="project">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <a href="{{ route('project.index') }}" class="portfolio-card">
                <img class="portfolio-card-img" src="assets/projects/ksl/Logo-Kabir-Securities-Limited.jpg" height="50%" width="100px" class="img-responsive rounded">
                <span class="portfolio-card-overlay">
                    <span class="portfolio-card-caption">
