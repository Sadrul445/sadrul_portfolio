            ...
            <div class="footer">
                <div class="social-links text-right m-auto ml-sm-auto">
                    <a href="https://www.linkedin.com/in/sadrulpashachowdhury?lipi=urn%3Ali%3Apage%3Ad_flagship3_profile_view_base_contact_details%3BICn5pJoLQceQgMEDCFQKWw%3D%3D"
                        class="link"><i class="fa-brands fa-linkedin fa-beat-fade"></i></a>
                    <a href="https://www.facebook.com/your_username" class="link"><i class="fa-brands fa-facebook fa-beat-fade"></i></a>
                    <a href="https://www.google.com/your_profile" class="link"><i class="ti-google"></i></a>
                    <a href="https://www.whatsapp.com/your_username" class="link"><i class="fa-brands fa-whatsapp fa-beat-fade"></i></a>
                    <a href="https://www.instagram.com/your_username" class="link"><i class="ti-instagram"></i></a>
                    <a href="https://www.your_rss_feed_url.com" class="link"><i class="ti-rss"></i></a>
                </div>
            </div>
            <p>
